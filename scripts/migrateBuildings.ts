...
const buildingData: Array<{
  ...
  { id: 'ModernTechnologyBldg', name: 'Modern Technology Building', description: 'The Modern Technology Building is a new addition to the facilities and buildings of the University. It is located near the exit and has three floors.', type: 'Academic', svgPath: 'M607 632.5L730.5 704L742 683L619.5 612L607 632.5Z', floors: 3 },
  { id: 'MechanicalTechnologyBldg', name: 'Mechanical Technology Building', description: 'The Mechanical Technology Building offers machineries and offices for faculty members and students taking Manufacturing Engineering Technology. Manufacturing Rooms can be found here.', type: 'Academic', svgPath: 'M733.5 627.5L610.5 556L600.5 575L722.5 647.5L733.5 627.5ZM779.5 547.5L656.5 476.5L610.5 556L733.5 627.5L779.5 547.5Z', floors: 2 },
  ...
  { id: 'ElectricalTechnologyBldg', name: 'Electrical Technology Building', description: 'ELECTRICAL ENGINEERING TECHNOLOGY BUILDING CONSISTS OF ROOMS AND OFFICES FOR ELECTRICAL TECHNOLOGY STUDENTS AND FACULTY', type: 'Academic', svgPath: 'M880.5 399.5L974.5 453.5L942.5 508.5L849 453.5L880.5 399.5Z', floors: 2 },
  { id: 'EngineeringBldg', name: 'Engineering Building', description: 'ENGINEERING BUILDING CONSISTS OF SURFACE MOUNTAIN TECHNOLOGY ROOM, OFFICE OF COLLEGE OF ENGINEERING AND REGISTRAR OFFICE', type: 'Academic', svgPath: 'M769.5 278L831 170L853.5 183L791.5 291L769.5 278Z', floors: 3 },
  ...
  { id: 'Garden', name: 'Garden', description: 'Landscaped garden area', type: 'Conservation', svgPath: 'M982 453.5L987.5 456.5L984 462.5L996.5 470L998.5 466.5L1011.5 474.5L983.5 523L967 513L964 517.5L949.5 509.5L982 453.5Z', floors: 0 },
  ...
  { id: 'TUPVDormitory', name: 'TUPV Dormitory', description: 'Student dormitory and housing', type: 'IGP', svgPath: 'M1313 349L1463 435.603L1548.5 287.512L1400 201.776L1313 349Z', floors: 3 },
...
async function migrateBuildings() {
  for (const b of buildingData) {
    try {
      const center = getCentroidFromPath(b.svgPath);
      await addBuilding({
        name: b.name,
